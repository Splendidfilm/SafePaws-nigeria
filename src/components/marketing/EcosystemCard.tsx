  ...
  return (
     <motion.div
              ...
              className="flex flex-col bg-[#f6f8f8] dark:bg-[#1a2e2b] border border-[#f0f4f4] dark:border-[#2a403d] 
                         rounded-3xl p-8 hover:border-primary hover:shadow-xl transition-all group"
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#D1F5EF] dark:bg-primary/20 
                              rounded-2xl mb-6 group-hover:bg-primary transition-colors">
                <Icon 
                  size={34} 
                  strokeWidth={2.25}
