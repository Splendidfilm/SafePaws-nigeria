...
export default function QuoteModal({isOpen , onClose} : QuoteProps) {
  ...
  return (
     <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm' >
        ...
        <h2 className='text-xl font-bold text-zinc-900' >Understanding Quotes</h2>
        <button 
        onClick={onClose}
        ...
        <div className="flex items-center justify-center gap-4">
            ...
            <div className="flex flex-col items-center justify-center p-6 bg-white border border-zinc-200 rounded-2xl transition-all shadow-2xl cursor-pointer group">
                ...
                <span className="material-symbols-outlined text-zinc-600 text-3xl">book</span>
                </div>
                <span className='font-bold text-zinc-800' >Quotes</span>
