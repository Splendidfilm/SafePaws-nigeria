...
export default function HelpCategories() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 dark:bg-[#11211e] bg-white">
      <div className="mb-12">
        <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50 ">Browse by Topic</h2>
        <p className="text-zinc-600 dark:text-zinc-200 mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 bg-amber-50 p-8 rounded-3xl border border-zinc-200 hover:shadow-lg transition-all group">
          ...
          <h3 className="text-2xl font-bold mb-6 text-zinc-900 ">Payments & Pricing</h3>
        ...
        <div className="md:col-span-7 bg-zinc-100 p-8 rounded-3xl border border-zinc-200 hover:shadow-lg transition-all group relative overflow-hidden">
          <div className="relative z-10">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-zinc-700 mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-3xl">verified_user</span>
            </div>
            <h3 className="text-2xl font-bold mb-4 text-zinc-900">Safety & Insurance</h3>
          ...
          <span className="material-symbols-outlined absolute -right-10 -bottom-10 text-[180px] text-zinc-900">verified_user</span>
        </div>
      </div>
