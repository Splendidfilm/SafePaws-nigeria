  ...
  return (
    <section className="py-24 bg-white dark:bg-[#11211e]">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-5xl dark:text-zinc-100 font-black text-zinc-900 mb-12 text-center">
          Core Values
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-zinc-900 mb-4 dark:text-zinc-200 ">{value.title}</h3>
