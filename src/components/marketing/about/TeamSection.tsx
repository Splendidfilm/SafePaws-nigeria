      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl">
            <h2  className="text-4xl font-black text-zinc-900 mb-4">Our Expert Handlers</h2>
          ...
          className="bg-zinc-900 text-white px-8 py-3 rounded-full font-bold hover:bg-[#17CFAD] transition-colors">
            Join the Team
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <div key={index} className="group">
              ...
              <p 
              className="text-zinc-600">{member.title}</p>
            </div>
          ))}
        </div>
      </div>
