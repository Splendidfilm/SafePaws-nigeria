    ...
    <section id="culture" className="py-24 bg-[#F8FAF9] dark:bg-[#11211e]  ">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-3xl border border-zinc-100 hover:border-[#17CFAD] dark:bg-[#1a2e2b] dark:border-[#2a403d] transition-all group">
            <div className="w-14 h-14 bg-[#D1F5EF] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined dark:text-zinc-800 text-[#17CFAD] text-4xl">favorite</span>
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-zinc-100 dark:bg-[#1a2e2b] dark:border-[#2a403d] hover:border-[#17CFAD] transition-all group">
            <div className="w-14 h-14 bg-[#D1F5EF] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-[#17CFAD] text-4xl  dark:text-zinc-800 ">groups</span>
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-zinc-100 dark:bg-[#1a2e2b] dark:border-[#2a403d] hover:border-[#17CFAD] transition-all group">
            <div className="w-14 h-14 bg-[#D1F5EF] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-[#17CFAD] text-4xl dark:text-zinc-800">lightbulb</span>
            </div>
