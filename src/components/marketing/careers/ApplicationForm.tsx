        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <section className="bg-white p-8 rounded-3xl border border-zinc-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium mb-2 text-zinc-500 ">LinkedIn Profile</label>
                  <input
                    name="linkedin"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-zinc-500 ">Portfolio / Website/ GitHub</label>
                  <input
                    name="portfolio"
