...
function HowItWorks() {
    ...
    const steps = [
        {number: 1, title: 'Request Quote', description: 'Enter pickup and destination details to getan instant price estimate.'},
...
<div className='flex flex-col items-start' >
        <h1 className='text-[#21302d] font-bold text-3xl dark:text-white ' >How It <span className='text-primary font-serif' >Works</span></h1>
