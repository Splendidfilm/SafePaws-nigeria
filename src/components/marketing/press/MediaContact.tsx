      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-bold text-zinc-900 mb-6">Media Inquiries</h2>
            ...
            <div className="space-y-8">
              <div className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">press@safepawsng.com</p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">+234 (0) 800-SAFE-PAWS</p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h4 className="font-bold text-zinc-900">Office Location</h4>
                  <p className="text-zinc-600">Lekki Phase 1, Lagos, Nigeria</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 bg-white p-10 rounded-3xl border border-zinc-100 shadow-sm">
            <h3 className="text-2xl font-bold text-zinc-900 mb-8">Quick Media Request</h3>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-zinc-700 mb-2">Media Outlet</label>
                  <input 
                    type="text" 
