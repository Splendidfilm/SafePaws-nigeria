...
export default function RefundPolicy({isOpen , onClose} : RefundPolicyProps) {
  ...
  return (
     <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm' >
        ...
        <h2 className='text-xl font-bold text-zinc-900' >Accepted Payment Methods</h2>
        <button 
        onClick={onClose}
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col items-center justify-center p-6 bg-white border border-zinc-200 rounded-2xl hover:border-[#17CFAD] transition-all cursor-pointer group ">
                ...
                <span className='font-bold text-zinc-800' >Paystack</span>
                <span className='text-xs textzinc-500 mt-1' >
                    Card & Bank App
                </span>
            </div>
            {/* Flutterwave */}
            <div className="flex flex-col items-center justify-center p-6 bg-white border border-zinc-200 rounded-2xl hover:border-[#17CFAD] transition-all cursor-pointer group">
                ...
                <span className='font-bold text-zinc-800' >Flutterwave</span>
                <span className='text-xs textzinc-500 mt-1' >
                    Mobile Money & Cards
                </span>
            </div>
